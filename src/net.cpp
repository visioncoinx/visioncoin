...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "VisionCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"default", "198.187.28.202"}, //First official node
    {NULL, NULL},
};

static const char *strTestNetDNSSeed[][2] = {
    {"default", "158.69.106.66"}, //First official node
    {NULL, NULL},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. VisionCoin is probably already running."), addrBind.ToString().c_str());
        else
